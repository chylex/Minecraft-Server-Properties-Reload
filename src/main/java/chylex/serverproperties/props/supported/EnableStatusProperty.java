...
public final class EnableStatusProperty extends BoolServerProperty {
	public static final EnableStatusProperty INSTANCE = new EnableStatusProperty();
	
	private EnableStatusProperty() {}
